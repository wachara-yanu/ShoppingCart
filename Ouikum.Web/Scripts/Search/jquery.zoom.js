...
(function ($) {
    var TikslusZoom = function (element, options) {
        ...
        var showZoomPreview = function () {
            ...
            var zoom_preview_left = small_img.position().left + small_img.width() + 60;
        ...
        //        console.log("img_ratio_width: " + img_ratio_width);
        //        console.log("img_ratio_height: " + img_ratio_height);

        //        if (options.zoomAnimation == true) {
        //            var bckpos1 = -(cleft * img_ratio_width)
        //            var bckpos2 = -(ctop * img_ratio_height);
        //            //console.log("bckpos1: " + bckpos1);
        //            //console.log("bckpos2: " + bckpos2);
        //            //element.find(".zoom-preview").animate({backgroundPosition:  bckpos1 + "px"  bckpos2 + "px" },35);
        //            element.find(".zoom-preview").animate({ 'background-position-x': bckpos1 + "px", 'background-position-y': bckpos2 + "px" }, options.zoomAnimationInterval);
        //        } else {
        //            console.log("-(cleft * img_ratio_width): " + -(cleft * img_ratio_width));
        //            console.log("-(ctop * img_ratio_height): " + -(ctop * img_ratio_height));
        //            if (img_ratio_width < 2 && img_ratio_height < 2) {
        //                element.find(".zoom-preview").css({ backgroundPosition: -(cleft * 2) + "px " + (-(ctop * 2) + "px") });
        //            } else if (img_ratio_height < 2) {
        //                element.find(".zoom-preview").css({ backgroundPosition: -(cleft * img_ratio_width) + "px " + (-(ctop * 2) + "px") });
        //            } else if (img_ratio_width < 2) {
        //                element.find(".zoom-preview").css({ backgroundPosition: -(cleft * 2) + "px " + (-(ctop * img_ratio_height) + "px") });
        //            } else {
        //                element.find(".zoom-preview").css({ backgroundPosition: -(cleft * img_ratio_width) + "px " + (-(ctop * img_ratio_height) + "px") });
        //            }
        //        }
        //        //console.log("options.lensWidth: " + options.lensWidth);
        //        //console.log("img_ratio_width: " + img_ratio_width);
        //        //console.log("options.lensHeight: " + options.lensHeight);
        //        //console.log("img_ratio_height: " + img_ratio_height);
        //        //console.log("options.lensWidth * img_ratio_width: " + options.lensWidth * img_ratio_width);
        //        //console.log("options.lensHeight * img_ratio_height: " + options.lensHeight * img_ratio_height);
        //        if (img_ratio_width < 2 && img_ratio_height < 2) {
        //            element.find(".zoom-preview").css("width", options.lensWidth * 2 + "px");
        //            element.find(".zoom-preview").css("height", options.lensHeight * 2 + "px");

        //            element.find(".zoom-preview-wrapper").css("width", options.lensWidth * 2 + "px");
        //            element.find(".zoom-preview-wrapper").css("height", options.lensHeight * 2 + "px");
        //        } else if (img_ratio_height < 2) {
        //            lement.find(".zoom-preview").css("width", options.lensWidth * img_ratio_width + "px");
        //            element.find(".zoom-preview").css("height", options.lensHeight * 2 + "px");
        ...
        var createOverlay = function () {
            ...
            $("#tiksluszoom_overlay").css({ left: 0, top: 0, width: screen_width + "px", height: "1000px", position: 'fixed' }).fadeIn("fast");
        }
        ...
        var createLightBox = function (width, height) {
            ...
            var lightbox = "<div id='tiksluszoom_lightbox' style='width:" + width + "px;left:" + left + "px;top:" + top + "px;height:" + height + "px;position:fixed;max-width:80%;max-height:80%;'><div class='tiksluszoom_lightbox_inner'></div><ul class='operations'><li><a href='#' class='tiksluszoom_lightbox_close'>Close</a></li></ul></div>";//<ul class='operations'><li></li></ul>
            //var lightbox = "<div class=\"pp_pic_holder light_rounded\" style=\"top: 649.5px; left: 555px; display: block; width: 473px;\"><div class=\"ppt\" style=\"opacity: 1; display: block; width: 433.3333333333333px;\">&nbsp;</div><div class=\"pp_top\"><div class=\"pp_left\"></div><div class=\"pp_middle\"></div><div class=\"pp_right\"></div></div><div class=\"pp_content_container\"><div class=\"pp_left\"><div class=\"pp_right\"><div class=\"pp_content\" style=\"height: 361px; width: 433px;\"><div class=\"pp_loaderIcon\" style=\"display: none;\"></div><div class=\"pp_fade\" style=\"display: block;\"><a href=\"#\" class=\"pp_expand\" title=\"Expand the image\" style=\"display: inline;\">Expand</a><div class=\"pp_hoverContainer\" style=\"height: 325px; width: 433px; display: none;\"><a class=\"pp_next\" href=\"#\">next</a><a class=\"pp_previous\" href=\"#\">previous</a></div><div id=\"pp_full_res\"><img id=\"fullResImage\" src=\"http://b2bmyanmar.blob.core.windows.net/upload/Product/34/46/ED98ICSVEE8C8WG.jpg\" style=\"height: 325px; width: 433px;\"></div><div class=\"pp_details\" style=\"width: 433.3333333333333px;\"><div class=\"pp_nav\" style=\"display: none;\"><a href=\"#\" class=\"pp_play\">Play</a><a href=\"#\" class=\"pp_arrow_previous\">Previous</a><p class=\"currentTextHolder\">1/1</p><a href=\"#\" class=\"pp_arrow_next\">Next</a></div><p class=\"pp_description\" style=\"display: none;\"></p><div class=\"pp_social\"></div><a class=\"pp_close\" href=\"#\">Close</a></div></div></div></div></div></div><div class=\"pp_bottom\"><div class=\"pp_left\"></div><div class=\"pp_middle\"></div><div class=\"pp_right\"></div></div></div>";
        ...
        var lightboxShowImage = function () {
            ...
            console.log("big_img: " + big_img);
            console.log("small_img: " + small_img);
            $(".tiksluszoom_lightbox_inner").prepend("<img  class='preview' src='" + element.find("img.tiksluszoom").attr("src") + "' style='max-width:100%;max-height:90%;'/>").fadeIn("slow");
            var width = $("img.preview").width();
            var left = ($(window).width() - width) / 2.2 + $(window).scrollLeft();
            $("#tiksluszoom_lightbox").css({ left: left + "px" });
            body.css({ cursor: 'default' });
