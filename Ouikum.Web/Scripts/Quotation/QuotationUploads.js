...
// แนบไฟล์
function onUploadCreateQuotation(e) {
    var files = e.files;
...
function onSuccessCreateQuotatiom(e) {
    OpenLoadingNew(false);
    try {
        ...
        var noImgPath = (IsAvatar == true) ? 'Content/Default/Images/noavatar.gif' : GetUpload("Temp/QuotationFile/" + getCookie("CompID") + "/" + FileName);
        var FullPath = (FileName == "" || FileName == null) ? url + noImgPath : GetUpload("Temp/QuotationFile/" + getCookie("CompID") + "/" + FileName);
